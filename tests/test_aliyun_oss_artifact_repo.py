...
def test_artifact_uri_factory(oss_bucket_mock):
    ...
    os.environ['MLFLOW_OSS_ENDPOINT_URL'] = 'temp_MLFLOW_OSS_ENDPOINT_URL'
    os.environ['MLFLOW_OSS_KEY_ID'] = 'temp_MLFLOW_OSS_KEY_ID'
    os.environ['MLFLOW_OSS_KEY_SECRET'] = 'temp_MLFLOW_OSS_KEY_SECRET'
